...
> منصة متكاملة لربط المتدربيين الجامعيين Palestinيين بفرص التدريب في الشركات، مع نظام ذكاء اصطناعي لتحليل السير الذاتية والمطابقة.
...
| العضو | الدور |
|-------|-------|
| **رولا سهيل أبو Ал-دهن** | مطورة المشروع |
| **المهندس فiras فوad الإجلا** | المشرف على المشروع |
