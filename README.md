...
> **ملاحظة:** أضف لقطات الشاشة الخاصة بالمشروع في مجلد `screenshots/` ثم عدّل الروابط أدناه.

| الواجهة | الصورة |
|---------|--------|
| الصفحة الرئيسية | ![](screenshots/01-home.png) |
| تسجيل الدخول | ![](screenshots/02-login.png) |
| لوحة تحكم المتدرب | ![](screenshots/08-trainee-dashboard.png) |
| بحث فرص التدريب | ![](screenshots/09-search.png) |
| تفاصيل فرصة تدريبية | ![](screenshots/10-internship-details.png) |
| ملف المتدرب الشخصي | ![](screenshots/12-my-profile.png) |
| مجتمع المتدربيين | ![](screenshots/14-community.png) |
| لوحة تحكم الشركة | ![](screenshots/18-company-dashboard.png) |
| نشر فرصة تدريبية | ![](screenshots/19-post-internship.png) |
| لوحة تحكم المشرف | ![](screenshots/24-supervisor-dashboard.png) |
| لوحة تحكم المسؤول | ![](screenshots/28-admin-dashboard.png) |
| التقارير والإحصائيات | ![](screenshots/31-reports-statistics.png) |
...
| **pip** | latest | مدير الحزم |
| **Gmail** | — | حساب مع App Password للإشعارات |
| **Gemini API** | — | مفتاح من Google AI Studio (اختياري - يعمل بدونه) |
| **نظام تشغيل** | Windows/Linux/macOS | متوافق مع الأنظمة الثلاثة |
...
| GET/DELETE | `content/` | إدارة المحتوى (فرص + منشورات + أقسام) |
| GET | `reports/` | التقارير والإحصائيات المتقدمة |
| GET/POST | `assign/` | قائمة التعيينات / إيعاز متدرب |
...
```
MIT License - Copyright (c) 2024 Rola Suhil Abu Al-dehen
```
...
| العضو | الدور | البريد |
|-------|-------|--------|
| **رولا سهيل أبو الدهن** | مطورة المشروع | Rolasuhil@gmail.com |
| **المهندس فراس العجلة** | المشرف على المشروع | — |

**الجامعة:** جامعة الأقصى - غزة  
**المقرر:** هندسة البرمجيات  
**الفصل:** الفصل الأول 2024/2025

---

## الدعم

- للاستفسارات والأخطاء، يرجى فتح [Issue](https://github.com/Rolasuhil/TrinLink-System/issues)
- للمشاركة في تطوير المشروع، يرجى فتح [Pull Request](https://github.com/Rolasuhil/TrinLink-System/pulls)
